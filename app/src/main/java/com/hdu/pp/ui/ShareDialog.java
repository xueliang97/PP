...
import com.hdu.pp.R;
import com.hdu.pp.view.PPImageView;
...
public class ShareDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        params.leftMargin = params.rightMargin = params.bottomMargin = params.topMargin = margin;
    ...
    private class ShareAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            Drawable drawable = resolveInfo.loadIcon(packageManager);//分享渠道的图标
