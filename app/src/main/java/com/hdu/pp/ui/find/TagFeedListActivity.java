...
import com.hdu.pp.R;
import com.hdu.pp.databinding.ActivityLayoutTagFeedListBinding;
import com.hdu.pp.databinding.LayoutTagFeedListHeaderBinding;
...
import com.hdu.pp.ui.home.FeedAdapter;
...
public class TagFeedListActivity extends AppCompatActivity implements View.OnClickListener, OnRefreshListener, OnLoadMoreListener {
    ...
    private void addHeaderView() {
        ...
        adapter.addHeaderVieew(headerBinding.getRoot());
    ...
    public PagedListAdapter getAdapter() {
        return new FeedAdapter(this, KEY_FEED_TYPE) {
            //在列表滚动时视频类型的item添加到playDetector中，自动播放 自动停止
            @Override
    ...
    protected void onDestroy() {
        PagedListPalyManager.release(KEY_FEED_TYPE);
        super.onDestroy();
    }
