...
import com.hdu.pp.R;
import com.hdu.pp.databinding.ActivityLayoutPreviewBinding;
...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void previewVideo(String previewUrl) { //播放本地资源
        ...
        if (file.exists()){
            ...
            FileDataSource fileDataSource = new FileDataSource();//文件类型数据源
            try {
